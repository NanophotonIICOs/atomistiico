...
def show_structures():
    ...
    with col_right:
        b_window=utils.get_structure_properties()
    ...
    with col_left:
        ...
        atoms = Show(afile)
        show_str = Show(afile).show_structure(background=b_window)
        #print(show_str._make_html())
        components.html(show_str._make_html(), height=500,width=500)
